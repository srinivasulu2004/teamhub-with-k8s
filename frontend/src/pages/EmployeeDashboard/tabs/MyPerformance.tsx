    ...
    switch (activeView) {
      case 'daily':
        return {
          dataKey: 'date',
          lines: [
            { key: 'rating', name: 'Rating', color: '#AD49E1' }, // Light purple
      ...
      case 'monthly':
        return {
          ...
          lines: [
            { key: 'rating', name: 'Rating', color: '#AD49E1' }, // Light purple
            { key: 'taskCompletion', name: 'Task %', color: '#10b981' },
            { key: 'behavior', name: 'Behavior', color: '#f59e0b' }
          ]
        };
      default:
          ...
          <CardContent className="p-6">
            <div className="flex items-start gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-purple-700 dark:text-purple-400 font-medium mt-2">
      ...
      <div className="flex gap-4 bg-white dark:bg-gray-800 p-2 rounded-xl border border-gray-200 dark:border-gray-700 w-fit">
        <button
          ...
          className={`px-6 py-2 rounded-lg font-medium transition-all ${activeView === 'daily'
            ? 'bg-gradient-to-r from-[#7A1CAC] to-[#AD49E1] text-white shadow-lg'
        ...
        <Card glassmorphism>
          <CardContent className="p-6">
            <div className="flex items-center gap-4">
              <div className="w-14 h-14 bg-gradient-to-br from-[#7A1CAC] to-[#AD49E1] rounded-xl flex items-center justify-center">
                ...
                >
                  ...
                  <div className="flex items-center gap-6">
                    <div className="text-right">
                      ...
                      <p className="text-lg font-bold text-[#AD49E1] dark:text-[#AD49E1]">
                        {day.rating}/10
                      </p>
                    </div>
                    <div className="text-right">
